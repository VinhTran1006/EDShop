    ...
    <body>
        ...
        <script>
            ...
            function submitReply(feedbackID) {
                ...
                xhr.open("POST", "ReplyFeedbackForAdmin", true);
            ...
            function toggleVisibility(feedbackID, currentStatus) {
                ...
                let xhr = new XMLHttpRequest();
                xhr.open("POST", "UpdateStatusCommentAdmin", true);
                xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            ...
            function openDeleteModal(feedbackID) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let xhr = new XMLHttpRequest();
                        xhr.open("POST", "DeleteReplyServletAdmin", true);
                        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            ...
            function openUpdateModal(feedbackID, currentText) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let xhr = new XMLHttpRequest();
                        xhr.open("POST", "UpdateReplyAdmin", true);
                        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                        xhr.onreadystatechange = function () {
                            if (xhr.readyState === 4) {
                                if (xhr.status === 200 && xhr.responseText.trim() === "Success") {
