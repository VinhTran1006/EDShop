        ...
        <div class="container">
            ...
            <div class="wrapper">
                <main class="main-content">
                    ...
                    <form class="search-form" action="CustomerListAdmin" method="get">        
                    ...
                    <table aria-label="Staff table">
                        ...
                        <tr>
                            ...
                            <td class="action-col">
                                <a href="CustomerListAdmin?action=changeStatus&id=<%= cus.getCustomerID()%>" 
                                   class="btn btn-warning">
                                    <%= cus.isActive() ? "Block" : "Unblock"%>
                                </a>
                                <a href="CustomerListAdmin?action=detail&id=<%= cus.getCustomerID()%>" class="btn btn-primary">Detail</a>                               
                            </td>
                        </tr>
                        <%
                            }
