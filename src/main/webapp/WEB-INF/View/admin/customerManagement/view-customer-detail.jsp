                ...
                <main class="main-content">
                    ...
                    <div class="container mt-5">
                        <div class="card mx-auto shadow" style="max-width: 700px; margin-left: 50px">
                            ...
                            <form method="post" action="CustomerListAdmin?action=detail">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <a href="CustomerListAdmin" class="btn btn-primary" id="back"><i class="bi bi-arrow-return-left"></i>Back to list</a>
                                    </div>
                            </form>
                            <%
                                }
