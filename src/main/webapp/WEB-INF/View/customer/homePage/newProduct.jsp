    ...
    <body>
        <div class="" style="width: 100%; border-radius: 15px; margin-top: 1%; background-color: #fff; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);">
            ...
            <div style="display: flex; border-radius: 10px;">
                ...
                <div class="product-scroll-wrapper">
                    <!-- Nút trái -->
                    <button style = "" onclick="scrollLeft()" class="scroll-btn scroll-left-new">←</button>

                    <!-- Danh sách sản phẩm -->
                    <div id="product-scroll-new" style = "gap: 0.25%">
                        <% if (productList != null) {
                    ...
                    <!-- Nút phải -->
                    <button style = "margin-left: 2%;" onclick="scrollRight()" class="scroll-btn scroll-right-new">→</button>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                document.querySelector('.scroll-left-new').addEventListener('click', () => {
                    container.scrollBy({left: -scrollAmount, behavior: 'smooth'});
                });

                document.querySelector('.scroll-right-new').addEventListener('click', () => {
                    container.scrollBy({left: scrollAmount, behavior: 'smooth'});
                });
            });
        </script>
