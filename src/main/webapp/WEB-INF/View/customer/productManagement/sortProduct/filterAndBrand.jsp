                ...
                <div style="background-color:#fff; padding: 20px; border-radius: 10px; width: 40%; margin: 5% auto;">
                    ...
                    <form action="SortProduct" method="get" onsubmit="return validateFilter()">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 10px;">
                            ...
                            <label class="price-pill" onclick="selectRadio(this)">
                                <input type="radio" name="priceRangeCategory" value="7to9-<%=categoryId%>" hidden>
                                <span>7 - 9 million</span>
                            </label>

                            <label class="price-pill" onclick="selectRadio(this)">
                                <input type="radio" name="priceRangeCategory" value="9to12-<%=categoryId%>" hidden>
                                <span>9 - 12 million</span>
                            </label>

                            <label class="price-pill" onclick="selectRadio(this)">
                                <input type="radio" name="priceRangeCategory" value="12to15-<%=categoryId%>" hidden>
                                <span>12 - 15 million</span>
                            </label>

                            <label class="price-pill" onclick="selectRadio(this)">
                                <input type="radio" name="priceRangeCategory" value="15to20-<%=categoryId%>" hidden>
