<%-- 
    Document   : infomationDetail
    Created on : Jul 10, 2025, 12:20:00 PM
    Author     : HP - Gia Khiêm
--%>
                        ...
                        <tr class="group-header" onclick="toggleDetails(<%= groupIndex%>)">
                            <td colspan="2" class="group-cell">
                                <div class="group-header-content">
                                    <h2 style="font-size: 14px; max-width: 50%; word-wrap: break-word; overflow-wrap: break-word; margin: 0;"><%= cateGroup.getNameCategoryDetailsGroup()%></h2>
