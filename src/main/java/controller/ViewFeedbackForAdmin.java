 ...
 * @author DONG QUOC
 */
public class ViewFeedbackForAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewFeedbackForAdmin</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewFeedbackForAdmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//sai từ khúc này 
        ...
        request.getRequestDispatcher("/WEB-INF/View/admin/feedbackManagement/ViewNewFeedback.jsp").forward(request, response);
    }
